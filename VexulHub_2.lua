...
local h, hrp
local setInfJump, setAntiRag, setFps, setMedusaCounter, setAutoTpDown, setUnwalkToggle
...
miniBtn.Size = UDim2.new(0,150,0,30); miniBtn.Position = UDim2.new(0,8,0,66)
miniBtn.BackgroundColor3 = Color3.fromRGB(0,0,0); miniBtn.BackgroundTransparency = 0
miniBtn.BorderSizePixel = 0; miniBtn.Text = "VEXUL HUB"
miniBtn.TextColor3 = Color3.fromRGB(255,255,255); miniBtn.Font = Enum.Font.GothamBlack
miniBtn.TextSize = 11; miniBtn.AutoButtonColor = false; miniBtn.Visible = false; miniBtn.ZIndex = 50
